...
//     7,
//   );
//   console.log('prayerDays', prayerDays, isPrayerWeekLoading);
...
//               className={
//                 isCurrent
//                   ? 'rounded-2xl border-emerald-300 bg-emerald-50/60 shadow-sm dark:border-emerald-800 dark:bg-emerald-950/30'
//                   : 'rounded-2xl'
//               }
//             >
...
//                 Complete prayer schedule for your current location
//               </p>
//             </div>
...
//                   className={
//                     isCurrent
//                       ? 'flex items-center justify-between gap-4 bg-emerald-50/60 px-5 py-4 dark:bg-emerald-950/20'
...
//                   <p className='text-foreground shrink-0 text-base font-semibold tabular-nums'>
//                     {formatPrayerTime(prayerTime, locationData?.timezone)}
//                   </p>
//                 </div>
//               );
